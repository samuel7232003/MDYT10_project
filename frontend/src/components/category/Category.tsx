    ...
    return (
        <section className="category">
            ...
            <div className='cover_grid'>
                <ul className='grid'>
                    <li className={cur === 8 ?'i1 choice':"i1"}><img src={image8} alt="" loading='lazy'/><p>MĐYT 8 - 2022</p></li>
                    <li className={cur === 2 ?'i2 choice':"i2"}><img src={image2} alt="" loading='lazy'/><p>MĐYT 2 - 2015</p></li>
                    <li className={cur === 3 ?'i3 choice':"i3"}><img src={image3} alt="" loading='lazy'/><p>MĐYT 3 - 2016</p></li>
                    <li className={cur === 4 ?'i4 choice':"i4"}><img src={image4} alt="" loading='lazy'/><p>MĐYT 4 - 2017</p></li>
                    <li className={cur === 7 ?'i5 choice':"i5"}><img src={image7} alt="" loading='lazy'/><p>MĐYT 7 - 2020</p></li>
                    <li className={cur === 6 ?'i6 choice':"i6"}><img src={image6} alt="" loading='lazy'/><p>MĐYT 6 - 2019</p></li>
                    <li className={cur === 5 ?'i7 choice':"i7"}><img src={image5} alt="" loading='lazy'/><p>MĐYT 5 - 2018</p></li>
                    <li className={cur === 1 ?'i8 choice':"i8"}><img src={image1} alt="" loading='lazy'/><p>MĐYT 1 - 2014</p></li>
                    <li className={cur === 9 ?'i9 choice':"i9"}><img src={image9} alt="" loading='lazy'/><p>MĐYT 9 - 2024</p></li>
                </ul>
            </div>
            <figure className='cloud'><img src={cloud} alt="" loading='lazy' /></figure>
        </section>
    )
}